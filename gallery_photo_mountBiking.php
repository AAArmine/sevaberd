            ...
            <div class="tab-pane fade show active" id="category_5" role="tabpanel" aria-labelledby="home-tab">
                <div class="photos_flex d-flex justify-content-around">
                    <?php 
                        ...
                        while($sql_photos_cat5 = mysqli_fetch_assoc($result_photos_cat5)){
                    ?>
                    <div class="photo_item" style="background-image: url('../photos/<?php echo $sql_photos_cat5['name'] ?>');">
                    </div>
                    <?php
                        }
                    ?>
                ...
                <div class="pagination-div mt-3">
                    ...
                    for ($i = 1; $i <= $numPages_cat5; $i++) {
                        if ($pageIndex5 == $i || (!$pageIndex5 && $i==1)) {
                            echo "<a href='gallery_photo_mountBiking.php?pageIndex5=" . $i . "' class='activePage'> " . $i . " </a>";
                        } else {
                            echo "<a href='gallery_photo_mountBiking.php?pageIndex5=" . $i . "'> " . $i . " </a>";
                        }
                    }
                    ?>
                </div>
