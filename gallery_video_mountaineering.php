            ...
            <div class="tab-pane fade show active" id="category_4" role="tabpanel" aria-labelledby="home-tab">
                <div class="photos_flex d-flex justify-content-around">
                    <?php 
                        ...
                        while($sql_videos_cat4 = mysqli_fetch_assoc($result_videos_cat4)){
                    ?>
                    <div><video width="320" height="240" src='../videos/<?php echo $sql_videos_cat4['name']; ?>' controls>
                ...
                <div class="pagination-div mt-3">
                    ...
                    for ($i = 1; $i <= $numPages_cat4; $i++) {
                        if ($pageIndex4 == $i || (!$pageIndex4 && $i==1)) {
                            echo "<a href='gallery_video_mountaineering.php?pageIndex4=" . $i . "' class='activePage'> " . $i . " </a>";
                        } else {
                            echo "<a href='gallery_video_mountaineering.php?pageIndex4=" . $i . "'> " . $i . " </a>";
                        }
                    }
                    ?>
                </div>
