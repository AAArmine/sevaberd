            ...
            <div class="tab-pane fade show active" id="category_2" role="tabpanel" aria-labelledby="home-tab">
                <div class="blog_flex d-flex justify-content-between">
                    <div class="blog_flex_item1">
                        <?php
                        if ($lang_menu == "am") {
                            while ($sql_blog_all_am = mysqli_fetch_assoc($result_blog_all_am)) {
                        ?>
                                <div class="blog_flex_item1_content">
                                    <div class="img_main" style="background-image: url('../img_admin/<?php echo $sql_blog_all_am['image'] ?>');">
                                        <div class="category_abs">
                                            <span class="vertically_center">
                                                <?php echo $sql_blog_all_am['category'] ?>
                                            </span>
                                        </div>
                                        <div class="category_abs_triangle"></div>
                                    </div>
                                    <div class="content_blog">
                                        <div class='date_blog'><?php echo $sql_blog_all_am['date_current'] ?></div>
                                        <h3><?php echo $sql_blog_all_am['title'] ?></h3>
                                        <div class="text_blog">
                                            <?php echo $sql_blog_all_am['text'] ?>
                                        </div>
                                        <a href="last_blog.php?id=<?php echo $sql_blog_all_am['id'] ?>">
                        ...
                        if ($lang_menu == "en") {
                            while ($sql_blog_all_en = mysqli_fetch_assoc($result_blog_all_en)) {
                            ?>
                                <div class="blog_flex_item1_content">
                                    <div class="img_main" style="background-image: url('../img_admin/<?php echo $sql_blog_all_en['image'] ?>');">
                                        <div class="category_abs">
                                            <span class="vertically_center">
                                                <?php echo $sql_blog_all_en['category'] ?>
                                            </span>
                                    ...
                                    <div class="content_blog">
                                        <div class='date_blog'><?php echo $sql_blog_all_en['date_current'] ?></div>
                                        <h3><?php echo $sql_blog_all_en['title'] ?></h3>
                                        <div class="text_blog">
                                            <?php echo $sql_blog_all_en['text'] ?>
                                        </div>
                                        <a href="last_blog.php?id=<?php echo $sql_blog_all_en['id'] ?>">
                                            <button class="see_more"><?php
                                                                        if ($lang_menu == "am") {
                                                                            echo "ՏԵՍՆԵԼ ԱՎԵԼԻՆ";
                                                                        }
                        ...
                        if ($lang_menu == "ru") {
                            while ($sql_blog_all_ru = mysqli_fetch_assoc($result_blog_all_ru)) {
                            ?>
                                <div class="blog_flex_item1_content">
                                    <div class="img_main" style="background-image: url('../img_admin/<?php echo $sql_blog_all_ru['image'] ?>');">
                                        <div class="category_abs">
                                            <span class="vertically_center">
                                                <?php echo $sql_blog_all_ru['category'] ?>
                                            </span>
                                            <!-- Historical and cultural places -->
                                        </div>
                                        <div class="category_abs_triangle"></div>
                                    ...
                                    <div class="content_blog">
                                        <div class='date_blog'><?php echo $sql_blog_all_ru['date_current'] ?></div>
                                        <h3><?php echo $sql_blog_all_ru['title'] ?></h3>
                                        <div class="text_blog">
                                            <?php echo $sql_blog_all_ru['text'] ?>
                                        </div>
                                        <a href="last_blog.php?id=<?php echo $sql_blog_all_ru['id'] ?>">
                    ...
                    <div class="blog_flex_item2">
                        ...
                        ?>
                                <div class="last_blog_cont">
                                    <a href="last_blog.php?id=<?php echo $sql_last_dates_am['id'] ?>">
                        ...
                        if ($lang_menu == "en") {
                            ...
                            ?>
                                <div class="last_blog_cont">
                                    <a href="last_blog.php?id=<?php echo $sql_last_dates_en['id'] ?>">
                        ...
                        if ($lang_menu == "ru") {
                            ...
                            ?>
                                <div class="last_blog_cont">
                                    <a href="last_blog.php?id=<?php echo $sql_last_dates_ru['id'] ?>">
                ...
                <div class="pagination-div mt-3">
                    ...
                    for ($i = 1; $i <= $numPages_all; $i++) {
                        if ($pageIndex == $i || (!$pageIndex && $i == 1)) {
                            echo "<a href='blogAll.php?pageIndex=" . $i . "' class='activePage'> " . $i . " </a>";
                        } else {
                            echo "<a href='blogAll.php?pageIndex=" . $i . "'> " . $i . " </a>";
                        }
                    }
                    ?>
                </div>
