            ...
            <div class="tab-pane fade show active" id="category_1" role="tabpanel" aria-labelledby="home-tab">
                <div class="photos_flex d-flex justify-content-around">
                    <?php 
                        ...
                        while($sql_videos_cat1 = mysqli_fetch_assoc($result_videos_cat1)){
                    ?>
                    <div><video width="320" height="240" src='../videos/<?php echo $sql_videos_cat1['name']; ?>' controls>
                ...
                <div class="pagination-div mt-3">
                    ...
                    for ($i = 1; $i <= $numPages_cat1; $i++) {
                        if ($pageIndex == $i || (!$pageIndex && $i==1)) {
                            echo "<a href='gallery_video_rest.php?pageIndex=" . $i . "' class='activePage'> " . $i . " </a>";
                        } else {
                            echo "<a href='gallery_video_rest.php?pageIndex=" . $i . "'> " . $i . " </a>";
                        }
                    }
                    ?>
                </div>
