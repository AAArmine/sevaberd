            ...
            <div class="tab-pane fade show active" id="category_8" role="tabpanel" aria-labelledby="home-tab">
                <div class="photos_flex d-flex justify-content-around">
                    <?php 
                        ...
                        while($sql_photos_cat8 = mysqli_fetch_assoc($result_photos_cat8)){
                    ?>
                    <div class="photo_item" style="background-image: url('../photos/<?php echo $sql_photos_cat8['name'] ?>');">
                    </div>
                    <?php
                        }
                    ?>
                ...
                <div class="pagination-div mt-3">
                    ...
                    for ($i = 1; $i <= $numPages_cat8; $i++) {
                        if ($pageIndex8 == $i || (!$pageIndex8 && $i==1)) {
                            echo "<a href='gallery_photo_riding.php?pageIndex8=" . $i . "' class='activePage'> " . $i . " </a>";
                        } else {
                            echo "<a href='gallery_photo_riding.php?pageIndex8=" . $i . "'> " . $i . " </a>";
                        }
                    }
                    ?>
                </div>
