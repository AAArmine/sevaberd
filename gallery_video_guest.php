            ...
            <div class="tab-pane fade show active" id="category_2" role="tabpanel" aria-labelledby="home-tab">
                <div class="photos_flex d-flex justify-content-around">
                    <?php 
                        ...
                        while($sql_videos_cat2 = mysqli_fetch_assoc($result_videos_cat2)){
                    ?>
                    <div><video width="320" height="240" src='../videos/<?php echo $sql_videos_cat2['name']; ?>' controls>
                ...
                <div class="pagination-div mt-3">
                    ...
                    for ($i = 1; $i <= $numPages_cat2; $i++) {
                        if ($pageIndex2 == $i || (!$pageIndex2 && $i==1)) {
                            echo "<a href='gallery_video_guest.php?pageIndex2=" . $i . "' class='activePage'> " . $i . " </a>";
                        } else {
                            echo "<a href='gallery_video_guest.php?pageIndex2=" . $i . "'> " . $i . " </a>";
                        }
                    }
                    ?>
                </div>
